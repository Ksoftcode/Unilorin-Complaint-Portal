...
INSERT INTO `tbl_students` (`cid`, `cname`, `cpass`, `address`, `email`, `c_mobile`, `date_time`) VALUES
...
INSERT INTO `tbl_staffs` (`eid`, `ename`, `epass`, `address`, `email`, `e_mobile`, `date_time`) VALUES
